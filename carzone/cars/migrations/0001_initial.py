# Generated by Django 5.0.6 on 2024-06-13 16:39
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('car_photo', models.ImageField(blank=True, upload_to='cars/photos/%Y/%m/%d')),
                ('car_photo_1', models.ImageField(blank=True, upload_to='cars/photos/%Y/%m/%d')),
                ('car_photo_2', models.ImageField(blank=True, upload_to='cars/photos/%Y/%m/%d')),
                ('car_photo_3', models.ImageField(blank=True, upload_to='cars/photos/%Y/%m/%d')),
                ('car_photo_4', models.ImageField(blank=True, upload_to='cars/photos/%Y/%m/%d')),
